...
<head>
  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    body { display: flex; min-height: 100vh; background: #f5f5f5; font-family: 'Segoe UI', system-ui, sans-serif; }
    ...
    .sidebar-brand-sub { font-size: 10px; color: #666; font-weight: 400; letter-spacing: 1px; text-transform: uppercase; margin-top: 2px; }
    ...
    .sidebar-nav a.active { color: #c9a96e; background: #2a2a2a; border-left-color: #c9a96e; }
    .sidebar-nav a svg { width: 18px; height: 18px; flex-shrink: 0; }

    .sidebar-footer { padding: 16px 20px; border-top: 1px solid #333; }
    .sidebar-user { display: flex; align-items: center; gap: 10px; margin-bottom: 12px; }
    .sidebar-avatar { width: 32px; height: 32px; background: #c9a96e; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-weight: 700; font-size: 13px; color: #1a1a1a; flex-shrink: 0; }
    .sidebar-user-info { font-size: 12px; color: #ccc; line-height: 1.3; }
    .sidebar-user-name { font-weight: 600; color: #fff; font-size: 13px; }
    .sidebar-logout { display: block; width: 100%; padding: 8px; background: none; border: 1px solid #444; color: #aaa; font-size: 12px; border-radius: 6px; cursor: pointer; text-align: center; transition: 0.2s; }
    .sidebar-logout:hover { background: #2a2a2a; color: #fff; border-color: #666; }

    /* Main content */
    .admin-main { margin-left: 240px; flex: 1; display: flex; flex-direction: column; }
    .admin-topbar { background: #fff; border-bottom: 1px solid #e5e5e5; padding: 0 32px; height: 64px; display: flex; align-items: center; justify-content: space-between; position: sticky; top: 0; z-index: 50; }
    .topbar-title { font-size: 16px; font-weight: 600; color: #333; }
    .topbar-actions { display: flex; align-items: center; gap: 16px; }
    .topbar-link { font-size: 13px; color: #c9a96e; text-decoration: none; }
    ...
    .stat-card-num { font-size: 28px; font-weight: 700; color: #1a1a1a; margin-bottom: 4px; }
    ...
    .stat-card-change.pos { color: #22c55e; }
    .stat-card-change.neg { color: #ef4444; }

    /* Table */
    .admin-card { background: #fff; border-radius: 12px; border: 1px solid #eee; margin-bottom: 24px; }
    .admin-card-header { padding: 20px 24px; border-bottom: 1px solid #eee; display: flex; align-items: center; justify-content: space-between; }
    .admin-card-title { font-size: 15px; font-weight: 600; color: #1a1a1a; }
    .admin-card-link { font-size: 12px; color: #c9a96e; text-decoration: none; }
    .admin-card-link:hover { text-decoration: underline; }
    .admin-table { width: 100%; border-collapse: collapse; }
    .admin-table th { padding: 12px 24px; text-align: left; font-size: 11px; font-weight: 600; color: #888; text-transform: uppercase; letter-spacing: 0.5px; border-bottom: 1px solid #eee; background: #fafafa; }
    .admin-table td { padding: 14px 24px; font-size: 13px; color: #333; border-bottom: 1px solid #f5f5f5; }
    .admin-table tr:last-child td { border-bottom: none; }
    .admin-table tr:hover td { background: #fafafa; }

    /* Status badges */
    .badge-status { display: inline-block; padding: 3px 10px; border-radius: 50px; font-size: 11px; font-weight: 600; }
    ...
    /* Loading */
    .loading-row td { text-align: center; padding: 40px; color: #aaa; }
    .loading-row td::before { content: 'Loading...'; }
