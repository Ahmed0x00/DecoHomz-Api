...
@section('extra_css')
<style>
.contact-layout { display: grid; grid-template-columns: 1fr 1fr; gap: 60px; padding: 60px 40px; max-width: 1200px; margin: 0 auto; }
.contact-info h1 { font-size: 32px; color: #2C1F14; margin-bottom: 20px; }
.contact-info p { color: #666; line-height: 1.8; margin-bottom: 30px; }
.info-item { display: flex; gap: 15px; margin-bottom: 24px; }
.info-icon { width: 40px; height: 40px; background: #F5F0E8; border-radius: 50%; display: flex; align-items: center; justify-content: center; flex-shrink: 0; }
.info-icon svg { width: 20px; height: 20px; stroke: #8B6A48; fill: none; }
.info-text h3 { font-size: 14px; color: #2C1F14; margin-bottom: 4px; }
.info-text p { font-size: 13px; color: #888; margin: 0; }
.contact-form { background: #fff; border: 1px solid #EDE8E2; padding: 40px; border-radius: 12px; box-shadow: 0 10px 30px rgba(0,0,0,0.03); }
.form-title { font-size: 18px; font-weight: 700; color: #2C1F14; margin-bottom: 24px; }
.submit-btn { width: 100%; background: #2C1F14; color: #fff; padding: 14px; border: none; border-radius: 6px; font-weight: 600; cursor: pointer; transition: 0.3s; }
.submit-btn:hover { background: #444; }
.map-section { height: 400px; background: #F5F0E8; border-radius: 12px; margin: 0 40px 60px; display: flex; align-items: center; justify-content: center; overflow: hidden; border: 1px solid #EDE8E2; }
@media (max-width: 768px) {
  .contact-layout { grid-template-columns: 1fr; padding: 30px 20px; gap: 40px; }
  .map-section { margin: 0 20px 40px; height: 300px; }
...
<div class="map-section">
  <div style="text-align:center; color:#8B6A48">
    <svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" style="margin-bottom:12px"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"/><circle cx="12" cy="10" r="3"/></svg>
